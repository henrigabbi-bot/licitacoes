...
function maskCEP(numberCEP){
    var cep = numberCEP.value;
    
    if (isNaN(cep[cep.length - 1])) { // Proibir caractere que não seja número
        numberCEP.value = cep.substring(0, cep.length - 1);
        return;
    }
