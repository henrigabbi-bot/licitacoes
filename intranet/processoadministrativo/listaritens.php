	...
	<body>
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
		        <h1 class="h2">Itens da Licitação</h1>	            
		        <div class="btn-toolbar mb-2 mb-md-0">
		        	<div class="btn-group mr-2">                  
                  <a class="btn btn-danger" href="deletaritens.php" role="button">Excluir Relatório</a>                                 
              </div> 
		            <div class="btn-group mr-2">		              
					...
					<thead>
	                    ...
	                    // Inclui o arquivo
	                    	...
	                    	$id_lic = $_GET['id'];
	                    	 $_SESSION['id']=$_GET['id'];
	                    // Consulta SQL
	                    	$sql ="SELECT *, produto.descricao, produto.unidade FROM itenslicitacao inner join produto on produto.codprod=itenslicitacao.codprod WHERE idlic ='$id_lic'";
	                    ...
	                    // Enquanto houverem registros no banco de dados
	                      	while($row = mysql_fetch_array($query)) {
		                        ...
		                        <tr>  
			                        ...
			                        <td><?php echo $row['vlrreferencia']; ?></td>                        
			                      </tr>
	                      <?php
	                    }
	                    ?>
