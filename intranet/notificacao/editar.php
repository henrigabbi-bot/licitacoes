							...
							<div class="row">
								<div class="col-md-6">												
									<div class="form-group">
										...
										<input type="text" name="nomefornecedor" id="nomefornecedor" maxlength="60" class="form-control" required value="<?php if(isset($_POST['nomefornecedor'])) { echo $_POST['nomefornecedor']; } else { echo $row_cli['nomefornecedor']; } ?>">
									</div>
									<div class="form-group">
										<label for="endereco">endereco</label>
										<input type="text" name="endereco" id="endereco" maxlength="60" class="form-control" required value="<?php if(isset($_POST['endereco'])) { echo $_POST['endereco']; } else { echo $row_cli['endereco']; } ?>">
									</div>	
									<div class="form-group">
										<label for="cidade">Cidade</label>
										<input type="text" name="cidade" id="cidade" maxlength="60" class="form-control" required value="<?php if(isset($_POST['cidade'])) { echo $_POST['cidade']; } else { echo $row_cli['cidade']; } ?>">
									</div>
									<div class="form-group">
										<label for="bairro">Bairro</label>
										<input type="text" name="bairro" id="bairro" maxlength="60" class="form-control" required value="<?php if(isset($_POST['bairro'])) { echo $_POST['bairro']; } else { echo $row_cli['bairro']; } ?>">
									</div>
								</div>
								<div class="col-md-6">	
									...
									<div class="form-group">
										...
										<input type="text" name="cep" id="cep" maxlength="60" class="form-control" required value="<?php if(isset($_POST['cep'])) { echo $_POST['cep']; } else { echo $row_cli['cep']; } ?>">
									</div>
									<div class="form-group">
