				...
				<?php
						...
						<form method="post" action="cadastrar.php">
							<div class="row">
                                ...
                                <input type="text" name="cpf" id="cep" class="form-control" placeholder="00000-000" maxlength="9" oninput="maskCEP(this)" required value="<?php if(isset($_POST['cep'])) { echo $_POST['cep']; } ?>">
                            	</div>
