	...
	<body>	
				...
				<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	            	<h1 class="h2">Importar Notas Fiscais de Fornecedor - Pregão <?php echo $npregao?> - Pedido <?php echo $npedido  ?></h1>	 
				...
				<?php
					 if(isset($_SESSION['aux'])) {
							...
							?>	<div class="alert alert-warning">
									...
									Aviso!<br>									
									<?php echo $msg3 ?> NF(s) já cadastrada(s). <br>
									<?php echo $msg ?> NF(s) cadastrada(s).
								</div>
							<?php
								unset($_SESSION['aux']);
								unset($_SESSION['msg']);							
