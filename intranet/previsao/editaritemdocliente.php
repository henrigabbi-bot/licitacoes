	...
	<body>
	        ...
	        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		        ...
		        <div class="btn-group mr-2">		              
			        <a class="btn btn-primary" href="listarprevisaodocliente.php" role="button">Voltar</a>
			    </div>    
			</div>   
						<?php
						// Carrega o arquivo
						...
						if($_GET['id']) {
							...
							$id_cli = $_GET['id'];
							// Cláusula SQL
							$sql_cli = "SELECT *, produto.descricao FROM previsaodeconsumo
							...
							if(mysql_num_rows($query_cli) == 1) {
								...
								if($_POST) {
									...
									// Executa a SQL
									$sql = "UPDATE previsaodeconsumo SET											
