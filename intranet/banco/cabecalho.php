        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../fornecedor/index.php">
                  <span class="far fa-building" data-feather="bar-chart-2"></span>
                  Fornecedor
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../licitacao/index.php">
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link" href="../previsao/index.php">
                  <span data-feather="file-text"></span>
                  Previsão de Consumo
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../pedidodecompra/index.php">
                  <span data-feather="file-text"></span>
                  Pedidos de Compra
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="../lerxml/index.php">
                  <span data-feather="file-text"></span>
                   Notas Fiscais de Saída
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../lerxmlfornecedor/index.php">
                  <span data-feather="file-text"></span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="../bancodepedidos/index.php">
                  <span data-feather="file-text"></span>
                   Banco de Pedidos
                </a>
              </li>
               ...
               <li class="nav-item">
                <a class="nav-link" href="../financas/index.php">
                  <span data-feather="file-text"></span>
                   Finanças
                </a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="../fracionalidade/index.php">
                  <span data-feather="file-text"></span>
                   Fracionalidade
                </a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="../notificacao/index.php">
                  <span data-feather="file-text"></span>
                   Gerar Notificação
                </a>
              </li>
