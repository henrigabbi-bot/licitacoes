	...
	<body>
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	     <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
		    <h1 class="h2">Licitações Cadastradas - Importar NF de Saída</h1>  
                ...
                <thead>
                   ...
                   <tbody>
                    ...
                    // Inclui o arquivo
                      include("../conexao.php");
                      // Consulta SQL     
                      $sql="SELECT pedido.codlic,pedido.npedido,pedido.data,licitacao.npregao  FROM pedido
                            INNER JOIN licitacao on pedido.codlic=licitacao.codlic ORDER BY pedido.data desc";                 
