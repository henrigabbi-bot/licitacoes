...
// NUMERO DE PEDIDOS DA LICITAÇÃO
  ...
  //1 PARA IMPRIMIR OS 2 PEDIDOS DO PROCESSO, 2 PARA IMPRIOMIR O ULTIMO PEDIDO DO PROCESSO 
  $pedidoaux2=2;
...
// NUMERO DE PEDIDOS DA LICITAÇÃO
     ...
     $ndepedidos2=$row['ndepedidos'];
		...
		$html5.='	<tr>';  
		$html5.='		<td colspan="6" width="100%">';
		$html5.=' 		<b>Registro de Preços Eletrônico Nº </b>'.$npregao3.'</td>';
		$html5.='	 </tr>';
		$html5.='	 <tr> '; 
		$html5.=' 		<td colspan="6" width="100%">';
		$html5.=' 		<b>Processo Nº </b>'.$nprocesso2.'</td>';
...
//referenciar o DomPDF com namespace
	...
	$dompdf->load_html('
      ...
      O presente relatório apresenta a economia gerada no período de <b>JANEIRO de 2023</b> a <b>DEZEMBRO de 2023</b>. Nesse
      período foram realizados os Pregões Eletrônicos '.$npregao3.', '.$npregao2.' e '.$npregao.' e quatro pedidos de medicamentos
      (FEVEREIRO/23, MAIO/23, AGOSTO/23, NOVEMBRO/23).
      </p>		
