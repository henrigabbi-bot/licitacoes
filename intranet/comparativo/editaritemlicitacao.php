...
<html>
	...
	<body>
	        ...
	        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		    	<h1 class="h2">Editar Item da Licitação</h1>	            
		        <div class="btn-group mr-2">		              
			        <a class="btn btn-primary" href="itenslicitacao.php" role="button">Voltar</a>
			    </div>    
			</div>   
						<?php
						// Carrega o arquivo
						...
						if($_GET['id']) {
							...
							$id_cli = $_GET['id'];
							// Cláusula SQL
							$sql_cli = "SELECT *, produto.descricao FROM itensprocesso
							...
							if(mysql_num_rows($query_cli) == 1) {
								...
								if($_POST) {
									...
									// Executa a SQL
									$sql = "UPDATE itensprocesso SET quantidade='$quantidade',vlrunitario='$vlrunitario' WHERE id='$id_cli';";
								...
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-md-12">
												<form method="post" action="editaritemlicitacao.php?id=<?php echo $id_cli; ?>">
													...
													<div class="form-group">
														...
														<input type="text" name="quantidade" id="quantidade" maxlength="60" class="form-control" required value="<?php if(isset($_POST['quantidade'])) { echo $_POST['quantidade']; } else { echo $row_cli['quantidade']; } ?>">
													</div>																									
