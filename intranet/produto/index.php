	        ...
	        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
		        ...
		        <div class="btn-toolbar mb-2 mb-md-0">
		            <div class="btn-group mr-2">		              
			            ...
			            <div class="btn-group mr-2">		              
			            	<a class="btn btn-primary" href="importarprodutos/importar.php" role="button">Importar Produtos</a> 			                          
			        </div>     	
	            </div>  
			</div> 
	                      	...
	                      	while($row = mysql_fetch_array($query)) {
		                        ...
		                        <tr>                                            	
		                          ...
		                          <td>
		                             ...
		                             <a title="Deletar registro" class="btn btn-danger" style="font-size:10px;" href="deletar.php?id=<?php echo $row['codprod'];?>">
