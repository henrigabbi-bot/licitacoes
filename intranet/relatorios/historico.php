          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm" id="minhaTabela">
              ...
              <tbody>
                <?php                      
                  include("../conexao.php"); 
                  $sql = "SELECT produto.codprod, produto.descricao, sum(pedidodecompra.quantidade) FROM `produto` 
LEFT join pedidodecompra on pedidodecompra.codprod=produto.codprod
